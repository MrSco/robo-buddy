 ...
 * how the window accelerates. Yank him sideways and the limbs lag behind and swing back;
 * drop him and they trail the fall. Purely procedural, layered over whatever clip plays.
 */
interface Chain {
  root: BoneName;
  mid: BoneName;
...
export class LimbSprings {
  ...
  /**
   * @param ax horizontal window acceleration, normalised (about +-1 for a hard yank)
